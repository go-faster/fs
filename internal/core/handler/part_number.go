...
// part's byte range. It always answers the request, including its error cases.
//
...
func (h *handler) servePartNumber(w http.ResponseWriter, r *http.Request, bucket, key, raw string) {
	ctx := r.Context()
