...
// The three sheared bars of the go-faster mark, lifted verbatim from this
// repository's logo generator (docs/logo/generate.py). The paths are authored
// around an origin of (-130.31, -190), so the group re-centers them on the
// viewBox — the same MARK_OFF the generator applies.
const BARS = [
