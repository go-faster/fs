...
func (s *ClusterNodeLive) Validate() error {
	...
	if err := func() error {
		if err := s.RebalanceState.Validate(); err != nil {
			return err
		}
		return nil
	}(); err != nil {
		failures = append(failures, validate.FieldError{
			Name:  "rebalance_state",
			Error: err,
		})
	}
	if len(failures) > 0 {
...
func (s *DiskWeight) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *DiskWeightList) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *MetadataPlaneRange) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s MetadataPlaneRangeStatus) Validate() error {
	switch s {
	case "served":
		return nil
	case "held":
...
func (s *SetDiskWeightRequest) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
